...
export const About = () =>{
    ...
    <section id="about" className="py-35 relative overflow-hidden">
        <div className="absolute inset-0">
            <img src="/hero-bg-2.jpg" alt="Hero image" className="w-full h-full object-cover opacity-40"/>
        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="animate-fade-in animate-float">
                    <span className="rounded-2xl glass px-4 py-3  bg-stone-950 text-white text-sm font-semibold tracking-wider uppercase">About Me</span>
                </div>
                ...
                <h2 className="text-4xl md:text-5xl  font-bold leading-tight animate-fade-in  animation-delay-100 text-yellow-400 ">
                    ...
                    <span className="font-serif italic font-normal text-white"> 
                        {" "}
                        it's managed with purpose..</span>
                </h2>

                <div className="space-y-4  text-white/50 animate-fade-in animation-delay-200">
                        <p>
            ...
            <div className="py-12 px-6">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
                    ...
                    <div className="w-20 h-1 bg-gradient-to-r from-yellow-400 to-amber-600 rounded-full mx-auto mb-8"></div>

                    <p className="max-w-xl mx-auto text-lg leading-9 text-gray-300 text-left">
        ...
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-50 animate-fade-in animation-delay-800">
        <button
            type="button"
            onClick={() => {
